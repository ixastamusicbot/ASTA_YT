...
from ASTA_YT.utils.database import (
    add_nonadmin_chat,
    get_authuser,
    get_authuser_names,
    get_playmode,
...
from ASTA_YT.utils.decorators.admins import ActualAdminCB
from ASTA_YT.utils.decorators.language import language, languageCB
from ASTA_YT.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from ASTA_YT.utils.inline.start import private_panel
...
@app.on_callback_query(
    filters.regex(
        pattern=r"^(SEARCHANSWER|PLAYMODEANSWER|PLAASTAYPEANSWER|AUTHANSWER|ANSWERVOMODE|VOTEANSWER|PM|AU|VM)$"
    )
    & ~BANNED_USERS
)
@languageCB
...
@app.on_callback_query(
    filters.regex(pattern=r"^(MODECHANGE|CHANNELMODECHANGE|PLAASTAYPECHANGE)$")
    & ~BANNED_USERS
)
@ActualAdminCB
