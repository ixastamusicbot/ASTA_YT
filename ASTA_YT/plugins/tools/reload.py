...
from ASTA_YT.utils.database import get_assistant, get_authuser_names, get_cmode
from ASTA_YT.utils.decorators import ActualAdminCB, AdminActual, language
from ASTA_YT.utils.formatters import alpha_to_int, get_readable_time
from ASTA_YT.mongo.afkdb import HEHE
...
async def restartbot(client, message: Message, _):
    ...
    if chat_id:
        ...
        try:
            db[chat_id] = []
            await ASTA.stop_stream_force(chat_id)
        except:
            pass
